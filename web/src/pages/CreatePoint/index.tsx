...
const CreatePoint = () => {
  ...
  async function handleSubmit(event: FormEvent) {
    ...
    if (!name || !email || !whatsapp || !uf || !city || !latitude || !longitude || items.length === 0) {
      alertMessage({
        title: 'É necessário preencher todos os campos corretamente!',
        type: 'error'
      });
    } else {
      ...
      try {
        ...
        alertMessage({
          title: 'Erro ao cadastrar ponto, tente novamente!',
          type: 'error'
        });
      }
    }
  ...
  function alertMessage(data: DataMessage) {
    confirmAlert({
      customUI: ({ onClose }) => {
        return (
          <div className='custom-ui' onClick={onClose}>
